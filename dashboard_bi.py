...
"NET": {
"01/2026":90,"02/2026":90,"03/2026":90
},
"CLARO TV": {
"01/2026":85.02,"02/2026":85.11,"03/2026":85.19
},
"EMBRATEL": {
"01/2026":80,"02/2026":80,"03/2026":80
},
"CLARO MOVEL": {
"01/2026":99.5,"02/2026":99.5,"03/2026":99.5
}
}
...
def obter_meta(empresa, mes):
    ...
    for chave in METAS:
        ...
        if chave in empresa:
            ...
            return METAS[chave].get(mes, np.nan)
...
def load_data():
    ...
    df["flag_d0"] = aging.str.contains(r"D\+0", regex=True)
    df["flag_d1"] = aging.str.contains(r"D\+1", regex=True)
    df["flag_d2"] = aging.str.contains(r"D\+2", regex=True)
...
with st.sidebar:
    ...
    for col in filtros:
        ...
        if col in df.columns:
            ...
            selecionados = st.multiselect(col, valores)

            if selecionados:

                mask &= df[col].isin(selecionados)
